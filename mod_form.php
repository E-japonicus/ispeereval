...
/**
 * The main ispeereval configuration form
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_ispeereval_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('ispeerevalname', 'ispeereval'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'ispeerevalname', 'ispeereval');
        ...
        // Adding the rest of ispeereval settings, spreading all them into this fieldset
